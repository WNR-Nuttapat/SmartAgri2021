...
SER1 = serial.Serial('COM6', baudrate = 115200, timeout = 1) # PWM SENT
SER2 = serial.Serial('COM7', baudrate = 1000000, timeout = 1) # ENC 4 front Motor
SER3 = serial.Serial('COM8', baudrate = 1000000, timeout = 1) # ENC 4 rear Motor
time.sleep(1)

#for Drive Motor usually use Kp and Ki
DriveMotor_Target=[120,120,120,120]
drv_kp=[1,1,1,1]
drv_ki=[0,0,0,0]
drv_kd=[0,0,0,0]
