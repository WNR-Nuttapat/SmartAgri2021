...
SER2 = serial.Serial('COM7', baudrate = 250000, timeout = 1) # ENC 4 front Motor
SER3 = serial.Serial('COM8', baudrate = 250000, timeout = 1) # ENC 4 rear Motor
time.sleep(1)

## Target Velocity and Omega ##
velocity=1
omega=0.3
######################
